...
<svg viewBox="0 0 700 260" xmlns="http://www.w3.org/2000/svg" font-family="sans-serif" font-size="13px">
  <defs>
    <marker id="arrow-e1" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><path d="M0,0 L8,3 L0,6 Z" fill="currentColor"/></marker>
  </defs>
  
  <!-- LSM-Tree 单机优化 (2010-2020) -->
  <rect x="40" y="10" width="620" height="60" rx="4" fill="transparent" stroke="currentColor" stroke-width="1.5"/>
  <text x="60" y="30" text-anchor="start" dominant-baseline="middle" fill="currentColor" font-weight="bold" font-size="14px">LSM-Tree 单机优化 (2010-2020)</text>
  <text x="60" y="50" text-anchor="start" dominant-baseline="middle" fill="currentColor" font-size="12px">├── Leveled vs Tiered compaction</text>
  <text x="60" y="66" text-anchor="start" dominant-baseline="middle" fill="currentColor" font-size="12px">├── Bloom filter + partition index</text>

  <!-- Vertical arrow -->
  <line x1="370" y1="70" x2="370" y2="100" stroke="currentColor" stroke-width="2" marker-end="url(#arrow-e1)"/>
  
  <!-- LSM-Tree 分布式调度 (2026+) -->
  <rect x="40" y="100" width="620" height="55" rx="4" fill="transparent" stroke="currentColor" stroke-width="1.5"/>
  <text x="60" y="120" text-anchor="start" dominant-baseline="middle" fill="currentColor" font-weight="bold" font-size="14px">LSM-Tree 分布式调度 (2026+)</text>
  <text x="60" y="140" text-anchor="start" dominant-baseline="middle" fill="currentColor" font-size="12px">└── Silo: Global compaction scheduling + task migration</text>
  
  <!-- Vertical arrow -->
  <line x1="370" y1="155" x2="370" y2="185" stroke="currentColor" stroke-width="2" marker-end="url(#arrow-e1)"/>
  
  <!-- LSM-Tree 湖仓融合 (2026+) -->
  <rect x="40" y="185" width="620" height="55" rx="4" fill="transparent" stroke="currentColor" stroke-width="1.5"/>
  <text x="60" y="205" text-anchor="start" dominant-baseline="middle" fill="currentColor" font-weight="bold" font-size="14px">LSM-Tree 湖仓融合 (2026+)</text>
  <text x="60" y="225" text-anchor="start" dominant-baseline="middle" fill="currentColor" font-size="12px">└── Fluss: Compaction → tiering → Iceberg lakehouse</text>
</svg>
