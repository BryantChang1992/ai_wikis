...
| 交叉领域 | 关联页面 | 说明 |
|----------|---------|------|
| LSM-Tree | [[synthesis/LSM-Tree-存储引擎体系综述]] | Compaction 策略和 DELETE_BITMAP 借鉴 LSM 思想 |
| 时序数据库 | [[synthesis/InfluxDB-时序数据库体系综述]] | Parquet 列存（Doris 4.0 计划 vs InfluxDB 3 已完成）、Compaction 策略对比 |
